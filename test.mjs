...
assert.match(simpleHtml, /name="generator" content="chatgpt-thread-archiver 0\.8\.1"/);
assert.match(simpleHtml, /Generated locally by chatgpt-thread-archiver 0\.8\.1/);
...
assert.match(embeddedImageHtml, /Generated locally by chatgpt-thread-archiver 0\.8\.1/);
...
assert.match(buildSource, /@version      0\.8\.1/);
